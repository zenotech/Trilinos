...
// ************************************************************
// ************************************************************
TEUCHOS_UNIT_TEST(BE, SinCos_ASA)
{
  ...
  for (int n=0; n<nTimeStepSizes; n++) {
    ...
    if (comm->getRank() == 0 && n == nTimeStepSizes-1) {
      ...
      std::ofstream ftmp("Tempus_BE_SinCos_AdjSens.dat");
  ...
  *my_out << "  =========================" << std::endl;
  ...
  if (comm->getRank() == 0) {
    std::ofstream ftmp("Tempus_BE_SinCos_AdjSens-Error.dat");
