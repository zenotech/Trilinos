...
#ifndef Tempus_StepperERK_decl_hpp
#define Tempus_StepperERK_decl_hpp
...
class StepperERK : virtual public Tempus::StepperExplicit<Scalar>
{
...
public:
  ...
  //@{
    ...
    virtual void setRKAppAction(
      Teuchos::RCP<StepperRKAppAction<Scalar> > appAction);

    virtual Teuchos::RCP<StepperRKAppAction<Scalar> > getRKAppAction() const
...
#endif // Tempus_StepperERK_decl_hpp
